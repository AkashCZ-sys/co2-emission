...
urlpatterns = [
    ...
    path('v1/country_list', views.CountryListAPIView.as_view(), name='country_list'),

    path('v1/location_create', views.LocationCreateAPIView.as_view(), name='location_create'),
    path('v1/location_list', views.LocationListAPIView.as_view(), name='location_create'),
    ...
    path('v1/carrier_list', views.CarrierListAPIView.as_view(), name='carrier_create'),
    ...
    # path('v1/company_list', views.CompanyListAPIView.as_view(), name='company_create'),
